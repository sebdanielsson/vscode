...
import { COPILOT_ENABLED_PLUGINS_KEY, COPILOT_EXTRA_MARKETPLACES_KEY, normalizeManagedSettings } from '../../common/copilotManagedSettings.js';
...
suite('normalizeManagedSettings', () => {
	...
	test('scalar structured key is not stringified', () => {
		const result = normalizeManagedSettings({
